...
<td style="width:220px" class="auto-style7" align = "center"> <?php echo ($row['position']); ?></td>
<td style="width:220px" class="auto-style7" align = "center"> <?php echo ($row['address']); ?></td>
...
if($num_results != 0)
{
	echo ("The total sales is ". $totalRevenue. " Euro");
}
